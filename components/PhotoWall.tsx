...
import { ArrowLeft, Camera, Star, Loader2, Share2, Trophy, TrendingUp, Users, Sparkles, Check, Copy, Link as LinkIcon } from 'lucide-react';
import { getWallImages } from '../services/cloudinary';
      ...
      {showSuccessModal && currentUpload && (
        <div className="absolute inset-0 bg-black/90 backdrop-blur-md z-50 flex items-center justify-center p-4 animate-fade-in">
          <div className="bg-gradient-to-br from-red-700 to-red-900 rounded-xl p-8 max-w-sm w-full text-center shadow-2xl border-4 border-white/20 animate-scale-in relative overflow-hidden">
            ...
            <h3 className="text-4xl font-sans font-black italic uppercase mb-2 text-white tracking-tighter transform -skew-x-6">You're a Star!</h3>
            ...
            <div className="bg-black/20 rounded p-3 mb-6">
              <p className="text-[10px] uppercase tracking-widest opacity-80 font-bold">You are Supporter #{metrics.totalPhotos}</p>
            </div>
      ...
      <header className="bg-gradient-to-r from-red-700 to-red-800 shadow-xl z-10 flex-none">
        ...
        {currentUpload && (
          <div className="bg-yellow-400 text-neutral-900 px-4 py-2 flex items-center justify-center gap-2">
            ...
            <p className="font-black italic text-sm uppercase">
              You're part of the movement, {userName}!
            </p>
          </div>
        )}
      </header>
            ...
            {images.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-neutral-400 p-6 text-center">
                ...
                <p className="text-sm text-neutral-500 max-w-xs">
                  Start the movement by adding your photo to the wall
                </p>
              </div>
            ) : (
              <div className="p-4">
                ...
                {currentUpload && (
                  <div className="mb-6 animate-fade-in-up">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <h3 className="font-black italic uppercase text-neutral-900 tracking-wide">
                        Just Added
                      </h3>
                    </div>
