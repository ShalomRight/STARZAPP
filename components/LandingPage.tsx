...
import { getPhotoHistory } from '../services/storage';
  ...
  return (
    <div className="h-full w-full bg-white flex flex-col relative">
      ...
      {selectedHistoryImage && (
        <div className="absolute inset-0 z-50 bg-black/95 flex items-center justify-center p-4 animate-fade-in">
            ...
            <div className="w-full max-w-sm flex flex-col gap-4">
                <img src={selectedHistoryImage} alt="History" className="w-full rounded-sm border-4 border-white shadow-2xl" />
      ...
      <div className="flex-1 flex flex-col p-6 relative overflow-y-auto">
        ...
        {error && <div className="bg-red-50 text-red-600 p-3 font-bold text-center border-2 border-red-100 uppercase italic mt-4">{error}</div>}
      </div>
